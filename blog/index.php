...
<center><br><font size="12px"><b style=color:rgb(255,153,0)> ประวัติเทศกาล<br></center></font><br>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div>
                                ...
                                <p><a class="btn btn-default" href="blog.php?article_id=<?php echo $row["id"]; ?>" role="button">Detail &raquo;</a></p>
                            </div>
                        </div>
                    </div>
                    <br>
